/**
 * Created by Shovkoplyas on 21.04.2016.
 */
...
public class Validate {
    ...
    public void run() {
        ...
        int n = inf.nextInt();
        inf.nextLine();
        ensureLimits(n, 3, MAXN, "Incorrect n");
        for (int i = 0; i < n; i++) {
            int a = inf.nextInt();
            ensureLimits(a, 1, MAXX, String.format("Incorrect a[%d]", i + 1));
        }
        inf.nextLine();
        inf.close();
    }
